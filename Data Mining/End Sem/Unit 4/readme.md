...
where pi is the proportion of examples in class ci.
...
> Gini = 1 - ∑(i=0->k) 𝑝𝑖^2.
- where 𝑝𝑖 is the probability of class in S.
...
- We ignore P(X) because it is the same for all classes.
...
- Important in medical tests: high sensitivity means few missed cases.
