...
7. Knowledge presentation (visualization, reporting)
...
5. Correlation – identifying statistical relationships between attributes.
6. Classification – assigning data to predefined classes (e.g. spam vs. non-spam).
7. Prediction – forecasting future trends based on past data.
8. Cluster Analysis – grouping similar data points together.

   - Classification type but in this the labels are unknown 
9. Outlier Analysis – finding abnormal or rare patterns.

   - eg noise , expceptions , frauds etc .
10. Evolution Analysis – tracking how patterns change over time.
